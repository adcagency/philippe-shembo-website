export const supportPage = {
  ...
  fr: {
    ...
    bodyHtml: `      <section class="section section--violet"><div class="shell"><p class="eyebrow">Soutenir le ministère</p><h1 class="section-title">Porter plus loin la vision.</h1><p class="section-intro">Votre soutien contribue au rayonnement du ministère, à la formation et aux œuvres menées sur le terrain. Utilisez uniquement les coordonnées confirmées par l’équipe.</p><div class="support-grid">
        <article class="support-card"><h2>Virement bancaire</h2><dl><dt>Banque</dt><dd>[À renseigner]</dd><dt>Titulaire</dt><dd>[À renseigner]</dd><dt>IBAN</dt><dd>[À renseigner]</dd><dt>BIC / SWIFT</dt><dd>[À renseigner]</dd></dl></article>
        <article class="support-card"><h2>Mobile money</h2><dl><dt>Opérateur</dt><dd>[À renseigner]</dd><dt>Numéro</dt><dd>[À renseigner]</dd><dt>Bénéficiaire</dt><dd>[À renseigner]</dd></dl></article>
        <article class="support-card"><h2>Autre moyen</h2><dl><dt>Nom</dt><dd>[À renseigner]</dd><dt>Devise</dt><dd>[À renseigner]</dd><dt>Instructions</dt><dd>[À renseigner]</dd></dl></article>
  ...
  en: {
    ...
    bodyHtml: `      <section class="section section--violet"><div class="shell"><p class="eyebrow">Support the ministry</p><h1 class="section-title">Carry the vision further.</h1><p class="section-intro">Your support contributes to the ministry’s reach, training and works on the ground. Use only details confirmed by the ministry team.</p><div class="support-grid">
        <article class="support-card"><h2>Bank transfer</h2><dl><dt>Bank</dt><dd>[To be provided]</dd><dt>Account holder</dt><dd>[To be provided]</dd><dt>IBAN</dt><dd>[To be provided]</dd><dt>BIC / SWIFT</dt><dd>[To be provided]</dd></dl></article>
        <article class="support-card"><h2>Mobile money</h2><dl><dt>Operator</dt><dd>[To be provided]</dd><dt>Number</dt><dd>[To be provided]</dd><dt>Beneficiary</dt><dd>[To be provided]</dd></dl></article>
        <article class="support-card"><h2>Other method</h2><dl><dt>Name</dt><dd>[To be provided]</dd><dt>Currency</dt><dd>[To be provided]</dd><dt>Instructions</dt><dd>[To be provided]</dd></dl></article>
